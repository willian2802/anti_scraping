...
# Encriptar senha
# senha = "minha_senha"
# senha_encriptada = Bcrypt.generate_password_hash(senha)

# # Verificar senha
# senha_digitada = "minha_senha"
# if bcrypt.check_password_hash(senha_encriptada, senha_digitada):
#     print("Senha correta!")
# else:
...
from MongoDB import insert_to_list
...
def trap_activated():
    ...
    insert_to_list("IP_black_list", ip_address)
